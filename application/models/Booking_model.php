...
class booking_model extends CI_Model
{
    ...
    {
        $sql = "SELECT `order`.id_order,food.name_food,food.price,`order`.qty FROM `order` inner join food on `order`.id_food = food.id_food where `order`.id_booking = $id_booking";
