 ...
 <div class="col-lg-6 col-md-6">
  <div class="table-responsive">
   ...
   <?php foreach($product as $row) { ?>
    ...
    <img src="<?php echo base_url($row->img) ?>" class="thumbnail"style="height: 100px; width: 100px;">
    ...
    <button type="button" name="add_cart" class="btn btn-success add_cart" data-productname=<?php echo $row->name_food ?> data-price=<?php echo $row->price ?> data-productid=<?php echo $row->id_food ?>>Add to Cart</button>
    </div>      
    <?php } ?>
  </div>
  </div>
