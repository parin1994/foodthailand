                ...
                <div class="row">
                    <div class="col-lg-9 main-chart">
                        ...
                        <div class="border-head">
                            ...
                            <form role="form" action="<?php echo base_url('carcareoffice/service/' . $method . '/' . $con->id_service) ?>" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="option" id="option" placeholder="" value="<?php echo $con->option ?>">
                                ...
                                <div class="box-footer">
                                    <button href="<?php echo base_url('carcareoffice/service/services') ?>" class="btn btn-primary" type="submit" name="btnsave" id="btnSave ">Save</button>
                                    <a href="<?php echo base_url('carcareoffice/service/index') ?>" class="btn btn-danger">Cancel</a>
